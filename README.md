# Before you can apply this logic on your bot, you need to create a mot from the discord website and make it join your server and give it the correct permissions like joining a channel speaking etc...
